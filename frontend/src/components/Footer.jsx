        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6 sm:gap-8">
          ...
          <div className="col-span-1 sm:col-span-2 md:col-span-2">
            <div className="flex items-center gap-2 sm:gap-3 mb-3 sm:mb-4">
              <div className="text-lg sm:text-xl font-semibold text-darkTeal" style={{ width: "56px" }}>
                <img src = "/logos/Arte Perfil.png" />
              </div>
              <span className="text-lg sm:text-xl font-semibold text-darkTeal" style={{ width: "200px" }}>
