...
const ScrollToTopButton = () => {
  ...
  return (
    <button
      onClick={scrollToTop}
      className="scroll-to-top-btn fixed bottom-6 right-6 z-50 w-12 h-12 rounded-full bg-primary primary-color-text-white shadow-lg hover:bg-primary-dark flex items-center justify-center"
      style={{
