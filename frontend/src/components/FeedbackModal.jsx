...
const FeedbackModal = ({ isOpen, onClose }) => {
  ...
  return createPortal(
    ...
    >
      <div
        className={`bg-white shadow-2xl max-w-md w-full max-h-[90vh] overflow-y-auto transition-all duration-300 ${
          isClosing 
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="flex gap-3 justify-end pt-4 border-t border-primary/20">
              ...
              <button
                ...
                className="px-4 py-2 text-sm font-medium bg-primary text-brandBlack rounded-md hover:bg-primary/90 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
              >
