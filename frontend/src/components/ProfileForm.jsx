            ...
            <div className="flex items-center gap-6">
              <div className="relative">
                {user.photo ? (
                  ...
                  <div className="w-24 h-24 rounded-full bg-primary text-brandBlack flex items-center justify-center text-2xl font-semibold border-4 border-primary/20">
              ...
              <div className="flex-1">
                ...
                <label
                  ...
                  className={`inline-flex items-center px-4 py-2 bg-primary text-brandBlack text-sm font-medium rounded-md hover:bg-primary/90 transition-colors cursor-pointer ${
