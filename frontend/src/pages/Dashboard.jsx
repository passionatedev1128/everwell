    ...
    <div className="min-h-screen bg-bgSecondary">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-4 sm:gap-6">
          ...
          <div className="lg:col-span-1">
            <div className="bg-white shadow-md p-3 sm:p-4" style={{ borderRadius: '40px' }}>
              <nav className="space-y-1.5 sm:space-y-2">
                <button
                  onClick={() => setActiveTab('overview')}
                  className={`w-full text-left px-4 py-2 rounded-md transition-all duration-300 relative overflow-hidden ${
                    activeTab === 'overview'
                      ? 'bg-primary text-brandBlack shadow-md transform scale-[1.02]'
          ...
          <div className="lg:col-span-3">
            <div className="bg-white shadow-md p-6" style={{ borderRadius: '40px' }}>
              <div 
                key={activeTab}
                      ...
                      {notifications.map((notification) => {
                        ...
                        return (
                          <div
                            ...
                            className={`p-4 hover:shadow-md transition-all relative ${
              ...
              {activeTab === 'feedbacks' && (
                <div>
                  <div className="flex items-center justify-between mb-6">
                    <h2 className="text-2xl font-bold text-darkTeal font-heading">Meus Feedbacks</h2>
                    <button
                      onClick={() => setIsFeedbackModalOpen(true)}
                      className="px-4 py-2 text-sm font-medium text-white bg-primary hover:bg-primary-dark transition-all duration-300 flex items-center gap-2 hover:scale-105 hover:shadow-md rounded-md"
                  ...
                  {feedbacks.length === 0 ? (
                    ...
                    <div className="space-y-4">
                      {feedbacks.map((feedback) => (
                        <div
                          key={feedback._id}
                          className="bg-primary/5 border border-primary/20 p-4 hover:shadow-md transition-all"
                          style={{ borderRadius: '40px' }}
                        >
                          <div className="flex items-start justify-between mb-2">
                            <div className="flex-1">
