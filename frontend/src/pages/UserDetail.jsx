...
import api, { updateDocumentStatus, getAllFeedbacksAdmin } from '../utils/api';
...
const UserDetail = () => {
  ...
  const fetchUserFeedbacks = async () => {
    try {
      const response = await getAllFeedbacksAdmin(null);
      if (response.success) {
        // Filter feedbacks by userId
        const userFeedbacks = (response.feedbacks || []).filter(f => f.userId?._id === userId || f.userId === userId);
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-2 space-y-6">
              ...
              <div className="space-y-4">
                <div className="flex items-center gap-4 pb-4 border-b border-gray-200">
                  {user.photo ? (
                    ...
                    <div className="w-20 h-20 rounded-full bg-primary text-brandBlack flex items-center justify-center text-2xl font-semibold">
            ...
            {/* Feedback Section */}
            <div className="bg-white rounded-xl shadow-lg p-6 mb-6">
              <h2 className="text-2xl font-semibold text-darkTeal mb-6">Feedbacks</h2>
              {feedbacks.length === 0 ? (
                <p className="text-mediumTeal">Nenhum feedback encontrado.</p>
              ) : (
                <div className="space-y-4">
